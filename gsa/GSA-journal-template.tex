...
\title{Template for preparing your submission to GSA Journals}
...
\runningtitle{GSA Journal Template} % For use in the footer 
...
\noindent This GSA journal template is provided to help you write your work in the correct journal format. Instructions for use are provided below. 

\section{Guide to using this template in Overleaf}

This template is provided to help you prepare your article for submission to GSA journals.
...
\item engage the broad readership of GENETICS/G3 and be understandable to a diverse audience (avoid using jargon);
...
\centering
\includegraphics[width=\linewidth]{example-figure}
\caption{Example movie (the figure file above is used as a placeholder for this example). GSA journals support video and movie files that can be linked from any portion of the article - including the abstract. Acceptable formats include .asf, avi, .wav, and all types of Windows Media files.   
}%
